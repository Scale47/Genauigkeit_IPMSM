...
%clear tblNullsystem grcOpts grcEvalL
    ...
    for ziNu = 3:length(rgkdUstrSpektrum) % nur Oberschwingungen ohne Grundschwingung durchgehen (1 = Gleichanteil, 2 = Grundschwingung)
        rgkdZSpektrum(1, ziNu) = fcnInterpolRstr(kdFfel*(ziNu-1), sRstrModel) + 1j * 2*pi*kdFfel*(ziNu-1) * (kdLWK+kdL2);    % HIER UNBEDINGT NOCH kdL2 HINZUFÜGEN
    end
    ...
    %end 
        ...
        filename = "AP"+index_AP_str+"_NoS_"+NoS_str+"_Simulation_"+d_str+"_Feinmodell_mit_L2.mat";
        save(filename)
        %bereinigt den Ordner IPMSMs.aedtresults
        oDesign.DeleteFullVariation("All", false);
        end
        ...
        %Ende for Schleife für Anpassung Stromspektrum
        end
    ...
    Ordner_Verlauf_Wirbelstromverluste = "C:\Users\scale\Desktop\Daten Umrichterspeisung mit L2";
    Ordner_Verlauf_Simulationszeit_Prozentuale_Abweichung = "C:\Users\scale\Desktop\Daten Umrichterspeisung mit L2";
    Ordner_Daten_Simulationszeit_Abweichung = "C:\Users\scale\Desktop\Daten Umrichterspeisung mit L2";
